<template>
  <div class="backtest-detail-page" v-loading="loading">
    <PageToolbar eyebrow="回测详情" :title="task?.task_name || `回测任务 #${taskId}`">
      <template #actions>
        <el-button plain @click="router.push(`/backtest/${taskId}/global-preview`)">全局预览</el-button>
    ...
    <template v-if="task">
      ...
      <el-tabs v-model="activeTab" class="backtest-detail-tabs">
        <!-- Logs Tab -->
...
import { getTaskResults } from '@/api/backtest'
