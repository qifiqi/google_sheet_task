...
def build_demo_report_data(report_type: str = "RPT") -> dict[str, Any]:
    ...
    report_data = {
        ...
        "charts": [
            {"title": "累计净值曲线", "image_path": "D:\\Users\\Administrator\\Desktop\\谷歌参数批量校验\\app\\services\\downloads\\策略回测报告图表\\累计净值曲线.png", "caption": "传入累计净值曲线 PNG 文件路径。"},
            {"title": "最大回撤曲线", "image_path": "D:\\Users\\Administrator\\Desktop\\谷歌参数批量校验\\app\\services\\downloads\\策略回测报告图表\\最大回撤曲线.png", "caption": "传入最大回撤曲线 PNG 文件路径。"},
            {"title": "超额收益曲线", "image_path": "D:\\Users\\Administrator\\Desktop\\谷歌参数批量校验\\app\\services\\downloads\\策略回测报告图表\\超额收益曲线.png", "caption": "传入累计超额收益曲线 PNG 文件路径。"},
            {"title": "分年度收益", "image_path": "D:\\Users\\Administrator\\Desktop\\谷歌参数批量校验\\app\\services\\downloads\\策略回测报告图表\\分年度收益.png", "caption": "传入分年度收益柱状图 PNG 文件路径。"},
            {"title": "日收益分布", "image_path": "D:\\Users\\Administrator\\Desktop\\谷歌参数批量校验\\app\\services\\downloads\\策略回测报告图表\\日收益分布.png", "caption": "传入日收益分布图 PNG 文件路径。"},
            {"title": "月度超额分布", "image_path": "D:\\Users\\Administrator\\Desktop\\谷歌参数批量校验\\app\\services\\downloads\\策略回测报告图表\\月度超额分布.png", "caption": "传入月度超额分布图 PNG 文件路径。"},
        ],
        "calculation_notes": [
        #     ("10.1 收益类指标", [
    ...
    report_data["weight_allocation"] = table(
        ["股票代码", "股票名", "权重"],
