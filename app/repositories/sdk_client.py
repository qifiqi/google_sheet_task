...
_REMOTE_ENDPOINTS: dict[tuple[str, str], tuple[str, str]] = {
    ...
    ("param_xpl_analysis_jobs", "delete"): ("POST", "/api/ParamXplAnalysisJobs/Delete"),
    ("param_xpl_analysis_jobs", "get_data_by_page_list"): ("POST", "/api/ParamXplAnalysisJobs/GetDataByPageList"),
    ("param_xpl_analysis_jobs", "get_info_by_id"): ("POST", "/api/ParamXplAnalysisJobs/GetInfoById"),
    ("param_xpl_analysis_jobs", "modify_or_add"): ("POST", "/api/ParamXplAnalysisJobs/ModifyOrAdd"),
    ("sys_role", "delete"): ("POST", "/api/SysRole/Delete"),
    ("sys_role", "get_by_id"): ("POST", "/api/SysRole/GetById"),
    ("sys_role", "get_data_by_page_list"): ("POST", "/api/SysRole/GetDataByPageList"),
    ("sys_role", "get_role_list_for_select"): ("POST", "/api/SysRole/GetRoleListForSelect"),
    ("sys_role", "is_role"): ("POST", "/api/SysRole/IsRole"),
    ("sys_role", "modify_or_add"): ("POST", "/api/SysRole/ModifyOrAdd"),
...
class StockSdkAdapter:
    ...
    def call(
        ...
        *,
        ...
        """
        ret_obj, _ = self.call_with_count(group_name, operation, payload, token=token)
        return ret_obj
