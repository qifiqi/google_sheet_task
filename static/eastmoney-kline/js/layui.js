/** v2.9.23 | MIT Licensed */ !(function(d) {
    'use strict';
    var t,
        h = d.document,
        ...
        ((o.prototype.cache = m),
            ...
            (o.prototype.use = function(n, t, e, o) {
                var r,
                    ...
                    s =
                    ((n = 'string' == typeof n ? [n] : 'function' == typeof n ? ((t = n), ['all']) : n),
                        d.jQuery &&
                        jQuery.fn.on &&
                    ...
                    ((m.modules[s] = e),
                        ...
                        (function o() {
                            return ++c > (1e3 * m.timeout) / 4 ?
                                ...
                                void(m.status[s] ? y() : setTimeout(o, 4));
                        })());
                }
                ...
                function y() {
                    e.push(layui[s]),
                        1 < n.length ?
                        a.use(n.slice(1), t, e, o) :
                        'function' == typeof t &&
                        (layui.jquery && 'function' == typeof layui.jquery && 'define' !== o ?
                ...
                return (
                    ...
                    0 === n.length || (layui['layui.all'] && N[s]) ?
                    y() :
                    ((i = (i =
                            (N[s] ? u + 'modules/' : (!/^\{\/\}/.test(a.modules[s]) && m.base) || '') +
                            (a.modules[s] || s) +
                            '.js').replace(/^\{\/\}/, '')), !m.modules[s] && layui[s] && (m.modules[s] = i),
                        m.modules[s] ?
                        (function f() {
                            return ++c > (1e3 * m.timeout) / 4 ?
                                g(s + ' is not a valid module', 'error') :
                        ...
                        (((r = h.createElement('script'))['async'] = !0),
                            ...
                            (r.src =
                                i +
                                ((u = !0 === m.version ? m.v || new Date().getTime() : m.version || '') ?
                                    '?v=' + u :
                                    '')),
                            l.appendChild(r), !r.attachEvent ||
            ...
            (o.prototype.link = function(n, o, t) {
                var r = this,
                    ...
                    l = 0;
                return (
                    (i.href = n + (m.debug ? '?v=' + new Date().getTime() : '')),
                    (i.rel = 'stylesheet'),
                    (i.id = a),
                    (i.media = 'all'),
                        ...
                        return ++l > (1e3 * m.timeout) / 100 ?
                            ...
                            void(1989 === parseInt(r.getStyle(e, 'width')) ?
                                (t === u && e.removeAttribute('lay-status'),
                                    e.getAttribute('lay-status') === u ? setTimeout(s, 100) : o()) :
            ...
            (o.prototype.router = o.prototype.hash =
                function(t) {
                    var n = {
                        path: [],
                        search: {},
            ...
            (o.prototype._typeof = o.prototype.type =
                function(t) {
                    return null === t ?
                        String(t) :
            ...
            (o.prototype._isArray = o.prototype.isArray =
                function(t) {
                    var e,
                        n = this.type(t);
                    return (!(!t || 'object' != typeof t || t === d) &&
        ...
        function(t, e, n, o) {
            ...
            return n === s ?
                ...
                ((m.event[t] = m.event[t] || {}),
                    u ?
                    (m.event[t][u] = [o]) :
                    ((m.event[t][u] = m.event[t][u] || []), m.event[t][u].push(o)),
                    this) :
...
!(function(d) {
    ...
    var t,
        ...
        ((Array.prototype.indexOf =
            ...
            (p.ie =
                ((t = navigator.userAgent.toLowerCase()), !!(d.ActiveXObject || 'ActiveXObject' in d) &&
            ...
            (p.style = function(t) {
                ...
                if (n)
                    return (
                        ...
                        (e.innerHTML = n),
                        (e.id =
                            'LAY-STYLE-' + (t.id || ((n = p.style.index || 0), p.style.index++, 'DF-' + n))),
            ...
            (p.position = function(t, e, n) {
                ...
                e &&
                    ((n = n || {}),
                        ...
                        'center' === n.align ?
                        (l -= (u - t.offsetWidth) / 2) :
                        'right' === n.align && (l = l - u + t.offsetWidth),
                        (l = l + u + c > o('width') ? o('width') - u - c : l) < c && (l = c),
                        i.bottom + s + c > o() &&
                        (i.top > s + c && i.top <= o() ?
                            (a = i.top - s - 2 * c) :
                            n.allowBottomOut || ((a = o() - s - 2 * c) < 0 && (a = 0))),
                        ...
                        p.hasScrollbar() ||
                        ((l = e.getBoundingClientRect()), !n.SYSTEM_RELOAD &&
                            l.bottom + c > o() &&
                            ((n.SYSTEM_RELOAD = !0),
                                setTimeout(function() {
                                    p.position(t, e, n);
            ...
            (p.onClickOutside = function(r, o, t) {
                var e,
                    ...
                    i,
                    c,
                    a = (t = t || {}).event || ('onpointerdown' in d ? 'pointerdown' : 'mousedown'),
                    u = t.scope || h,
                    s = t.ignore || [],
                ...
                e =
                    ...
                    (e = e
                        ...
                        .replace(n.tagExp(), function(e) {
                            return (
                                '";' + (e = e.replace(o, '').replace(p, '')).replace(/\\(.)/g, '$1') + ';view+="'
                            );
                        })
        ...
        ((t.prototype.type = function() {
            ...
            (t.prototype.view = function() {
                var i,
                    ...
                    u =
                    ((n.layout = 'object' == typeof n.layout ? n.layout : ['prev', 'page', 'next']),
                    ...
                    l = {
                        ...
                        page: (function() {
                            ...
                            for (
                                i - t < r - 1 && (t = i - r + 1), !1 !== n.first && 2 < t && e.push('<span class="layui-laypage-spr">...</span>'); t <= i; t++
                            )
                                t === n.curr ?
                                e.push(
                            ...
                            return (
                                ...
                                n.pages > i &&
                                !1 !== n.last &&
                                (i + 1 < n.pages && e.push('<span class="layui-laypage-spr">...</span>'),
                                    0 !== r) &&
                                e.push(
                        ...
                        next: n.next ?
                            ...
                            '</a>' :
                            '',
                        count: '<span class="layui-laypage-count">' +
                            (e = 'object' == typeof n.countText ? n.countText : ['\u5171 ', ' \u6761'])[0] +
                            n.count +
                            e[1] +
                            '</span>',
                        limit:
                            ((i = ['<span class="layui-laypage-limits"><select lay-ignore>']),
                                layui.each(n.limits, function(e, a) {
                                    ...
                                    i.push(
                                        ...
                                        '>' +
                                        ((t = (a = a) + ' \u6761/\u9875'),
                                            ('function' == typeof n.limitTemplet && n.limitTemplet(a)) || t) +
                                        '</option>'
                                    );
                                }),
                                i.join('') + '</select></span>'),
...
!(function(i, D) {
    ...
    (k.prototype.init = function() {
        ...
        o.elem[0] &&
            ('array' !== layui.type(o.theme) && (o.theme = [o.theme]),
                ...
                ((t = r.lang()), (o.weekStart = t.weeks.indexOf(o.weekStart)), -1 === o.weekStart) &&
                (o.weekStart = 0),
                (r.EXP_IF = ''),
                (r.EXP_SPLIT = ''),
    ...
    (k.prototype.render = function() {
        var a,
            ...
            (o.zIndex && (y.style.zIndex = o.zIndex),
                    ...
                    var a = lay.elem('div', { class: 'layui-laydate-header' }),
                        t = [
                            ...
                            (((t = lay.elem('i', {
                                ...
                                t),
                            ((t = lay.elem('div', { class: 'laydate-set-ym' })).appendChild(lay.elem('span')),
                ...
                lay(e).html(
                    ((p = []),
                        (n = []),
                        'datetime' === o.type &&
                        p.push('<span lay-type="datetime" class="' + I + '">' + d.timeTips + '</span>'),
                        (o.range || 'datetime' !== o.type || o.fullPanel) &&
                        p.push('<span class="' + x + '" title="' + d.preview + '"></span>'),
            ...
            (lay.each(o.theme, function(e, t) {
                        ...
                        ((g = !(l = !0)),
                            f.push(
                                [
                                    ...
                                    '#{{id}} li.layui-this,#{{id}} td.layui-this>div{background-color:{{theme}} !important;}', -1 !== o.theme.indexOf('circle') ?
                                    '' :
                ...
                o.shortcuts &&
                o.range &&
                f.push('#{{id}}.layui-laydate-range{width: 628px;}'.replace(/{{id}}/g, r.elemID)),
                f.length &&
                ((f = f.join('')),
                    'styleSheet' in p ?
    ...
    (k.prototype.holidaysRender = function(r, o, e) {
        var d = ['holidays', 'workdays'],
            s = function(e, t, a) {
                e.find('div').html(
                    ['<span', ' class="laydate-day-holidays"', ' type="' + t + '"', '>', a, '</span>'].join(
                        ''
                    )
                );
            };
    ...
    (k.prototype.list = function(n, i) {
        ...
        return (
            ...
            ((r = function() {
                                ...
                                .each(function(e, t) {
                                    s.limit({
                                        ...
                                        date: [
                                            ...
                                            { hours: s[k].hours, minutes: s[k].minutes, seconds: e },
                                        ][a],
                                        index: i,
                                        rangeType: i,
                                        disabledType: 'time',
                ...
                y.range ? s[k] || (s[k] = 'startTime' === k ? m : s.endDate) : (s[k] = m),
                ...
                .on('click', function() {
                    ...
                    lay(this).hasClass(C) ||
                        (s.rangeLinked ?
                            ...
                            (t = 'year' === n && -1 !== ['date', 'datetime'].indexOf(y.type)),
                            e || t ?
                            (lay(h)
                                .find('.' + M)
                                .removeClass(M),
                        ...
                        .on('click', function() {
                            ...
                            lay(this).hasClass(C) ||
                                (y.range ? (s[k][w[t]] = e) : (m[w[t]] = e),
                                    ...
                                    r(),
                                    d(),
                                    (!s.endDate && 'time' !== y.type && 'datetime' !== y.type) ||
                                    s.done(null, 'change'),
                                    s.setBtnStatus());
                        });
                }),
    ...
    (k.prototype.setBtnStatus = function(e, t, a) {
        var n = this,
            ...
            o =
            'datetime' === i.type || 'time' === i.type ? ['hours', 'minutes', 'seconds'] : undefined;
        i.range &&
            ((t = t || (n.rangeLinked ? n.startDate : i.dateTime)),
                ...
                e) &&
            i &&
            n.hint('string' == typeof e ? l.timeout.replace(/\u65e5\u671f/g, e) : l.timeout);
    }),
    ...
    (k.prototype.setValue = function(e) {
        ...
        return (
            ...
            ((e = e || ''),
                ...
                lay(i).val(e) :
                (t = a.rangeElem) ?
                ('array' !== layui.type(e) && (e = e.split(' ' + a.rangeStr + ' ')),
                    t[0].val(e[0] || ''),
                    t[1].val(e[1] || '')) :
                (0 === lay(i).find('*').length &&
                    ((t = 'function' == typeof n.formatToDisplay ? n.formatToDisplay(e) : e),
                        lay(i).html(t)),
        ...
        l.range && !i.endState && lay(i.footer).find(E).addClass(C),
            ...
            lay.each(e, function(e, t) {
                ...
                l.rangeLinked &&
                    ...
                    lay(t).addClass(lay(t).hasClass(y) || lay(t).hasClass(m) ? '' : 'laydate-day-now'),
                    lay(t).removeClass(o + ' ' + M),
                    (a !== r && a !== n) ||
                    ((i.rangeLinked || (!i.rangeLinked && (e < 42 ? a === r : a === n))) &&
                        lay(t).addClass(lay(t).hasClass(y) || lay(t).hasClass(m) ? o : M)),
    ...
    (k.prototype.checkPanelDate = function(e, t) {
        ...
        if ('date' === n.type || 'datetime' === n.type)
            return (
                ...
                (n = this.endState && ((n && a < e) || (!n && e < a)) ? 1 - t : t), { needFullRender: e !== a, index: n }
            );
    }),
                    ...
                    if (n.range) {
                        if (lay(t).hasClass(C))
                            return (
                                    ...
                                    a.startDate &&
                                    a.endDate &&
                                    a.newDate(lay.extend({}, a.startDate, a.startTime || {})) >
...
!(function(e, t) {
                            ...
                            PSEUDO: function(e) {
                                ...
                                return f.CHILD.test(e[0]) ?
                                    ...
                                    (e[3] ?
                                        ...
                                        n &&
                                        te.test(n) &&
                                        (t = (t = w(n, !0)) && n.indexOf(')', n.length - t) - n.length) &&
                                ...
                                ((m = o),
                                    ...
                                    (r = function(e, t, n, r, i) {
                                        ...
                                        for (i && (T = t === E || t || i); l !== g && null != (o = p[l]); l++) {
                                            if (x && o) {
                                                for (a = 0, t || o.ownerDocument === E || (C(o), (n = !N));
                                                    (s = m[a++]);)
                                                    if (s(o, t || E, n)) {
                                                        r.push(o);
                                                        break;
                ...
                (P = H.select =
                    function(e, t, n, r) {
                        ...
                        if (((n = n || []), 1 === c.length)) {
                            ...
                            for (
                                i = f.needsContext.test(e) ? 0 : o.length; i-- && ((a = o[i]), !b.relative[(s = a.type)]);
            ...
            closest: function(e, t) {
                for (
                    var n,
                        ...
                        i = this.length,
                        o = [],
                        a = Y.test(e) || 'string' != typeof e ? C(e, t || this.context) : 0; r < i; r++
                )
    ...
    function Ne(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f, d = e.length, p = be(t), h = [], g = 0; g < d; g++)
            ...
            for (
                ...
                u = u.lastChild;
            if (
                (!y.leadingWhitespace && ve.test(a) && h.push(t.createTextNode(ve.exec(a)[0])), !y.tbody)
            )
                for (
                    o =
                    (a =
                        ...
                        0 :
                        u :
                        u.firstChild) && a.childNodes.length; o--;
        ...
        for (u && p.removeChild(u), y.appendChecked || C.grep(b(h, 'input'), Ee), g = 0;
            (a = h[g++]);)
    ...
    function Me(e, t, n, r, i, o) {
        ...
        if (
            (null == r && null == i ?
                ((i = n), (r = n = undefined)) :
                null == i &&
                ('string' == typeof n ? ((i = r), (r = undefined)) : ((i = r), (r = n), (n = undefined))), !1 === i)
        )
            i = u;
        else if (!i) return e;
        return (
                ...
                return (
                    ...
                    ((r = (n = e.target.ownerDocument || g).documentElement),
                        ...
                        (e.pageY =
                            ...
                            ((r && r.clientTop) || (n && n.clientTop) || 0))), !e.relatedTarget && o && (e.relatedTarget = o === e.target ? t.toElement : o),
        ...
        C.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                if (e && e.preventDefault && e.handleObj)
                    ...
                    if ('object' != typeof e)
                        return (
                            (!1 !== t && 'function' != typeof t) || ((n = t), (t = undefined)), !1 === n && (n = u),
                            this.each(function() {
    ...
    C.extend({
            ...
            cleanData: function(e, t) {
                for (
                    var n, r, i, o, a = 0, s = C.expando, u = C.cache, l = y.attributes, c = C.event.special; null != (n = e[a]); a++
                )
                    ...
                    if (
                        ('string' === (o = typeof n) &&
                            ...
                            ('number' === o && (n += (i && i[3]) || (C.cssNumber[s] ? '' : 'px')),
                                y.clearCloneStyle || '' !== n || 0 !== t.indexOf('background') || (u[t] = 'inherit'), !(a && 'set' in a && (n = a.set(e, n, r)) === undefined)))
                    )
                        try {
                            u[t] = n;
                        } catch (l) {}
    ...
    (C.Animation = C.extend(A, {
        ...
        tweener: function(e, t) {
            for (
                var n, r = 0, i = (e = C.isFunction(e) ? ((t = e), ['*']) : e.match(E)).length; r < i; r++
            )
            ...
            ajax: function(e, t) {
                    ...
                    b = {
                        ...
                        getResponseHeader: function(e) {
                            ...
                            if (2 === x) {
                                if (!r)
                                    for (r = {};
                                        (t = zt.exec(l));) r[t[1].toLowerCase()] = t[2];
                                t = r[e.toLowerCase()];
                            }
                ...
                if (
                    ...
                    for (n in ((f = C.event && p.global) && 0 == C.active++ && C.event.trigger('ajaxStart'),
                            ...
                            (u = p.url),
                            p.hasContent ||
                            (p.data && ((u = p.url += (Bt.test(u) ? '&' : '?') + p.data), delete p.data), !1 === p.cache &&
                                (p.url = $t.test(u) ?
                                    u.replace($t, '$1_=' + Pt++) :
                                    u + (Bt.test(u) ? '&' : '?') + '_=' + Pt++)),
                            p.ifModified &&
    ...
    return (
        (C.fn.load = function(e, t, n) {
            ...
            return 'string' != typeof e && gn ?
                ...
                ((a = this), -1 < (s = e.indexOf(' ')) && ((r = C.trim(e.slice(s, e.length))), (e = e.slice(0, s))),
        ...
        C.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent; e && !C.nodeName(e, 'html') && 'static' === C.css(e, 'position');
...
!(function(p, m) {
    ...
    var h,
        ...
        f = {
            getPath:
                ((e =
                        document.currentScript && 'SCRIPT' === document.currentScript.tagName.toUpperCase() ?
                        document.currentScript.src :
                        (function() {
                            for (
                                var e, t = document.getElementsByTagName('script'), i = t.length - 1, n = i; 0 < n; n--
                            )
                        ...
                        return 100 < ++l ?
                            ...
                            void(1989 === parseInt(f.getStyle(t, 'width')) ?
                                (e === r && t.removeAttribute('lay-status'),
                                    t.getAttribute('lay-status') === r ? setTimeout(c, 100) : i()) :
        ...
        v = {
            v: '3.7.0',
            ie:
                ((e = navigator.userAgent.toLowerCase()), !!(p.ActiveXObject || 'ActiveXObject' in p) && ((e.match(/msie\s(\d+)/) || [])[1] || '11')),
            ...
            confirm: function(e, t, i, n) {
                ...
                return (
                    a && ((n = i), (i = t)),
                    v.open(h.extend({ content: e, btn: f.btn, yes: i, btn2: n }, a ? {} : t))
                );
            },
            msg: function(e, t, i) {
                var n = 'function' == typeof t,
                ...
                return (
                    ...
                    v.open(
                        h.extend({
                            ...
                            ((-1 !== (t = t || {}).icon && (t.icon !== m || f.config.skin)) ||
            ...
            load: function(e, t) {
                return v.open(
                    h.extend({ type: 3, icon: e || 0, resize: !1, shade: 0.01, removeFocus: !1 }, t)
                );
            },
            tips: function(e, t, i) {
                return v.open(
        ...
        ((t.pt.config = {
                    ...
                    t(
                        [
                            ...
                            ((n = []),
                                ...
                                a.closeBtn &&
                                n.push(
                                    '<span class="layui-icon layui-icon-close ' + [u[7], u[7] + (a.title ? a.closeBtn : 4 == a.type ? '1' : '2')].join(' ') +
                                    '"></span>'
                                ),
                                n.join('')) +
                            '</div>' +
                            (a.btn ?
                                (function() {
                                    ...
                                    return (
                                        '<div class="' +
                                        ((t = [u[6]]), a.btnAlign && t.push(u[6] + '-' + a.btnAlign), t.join(' ')) +
                                        '">' +
                                        e +
                                        '</div>'
                                    );
                ...
                if (o.id && h('.' + u[0]).find('#' + o.id)[0])
                    ...
                    switch (
                        (o.removeFocus && document.activeElement && document.activeElement.blur(),
                            'string' == typeof o.area && (o.area = 'auto' === o.area ? ['', ''] : [o.area, '']),
                            6 == v.ie && (o.fixed = !1),
                            o.type)
                    ) {
                        case 0:
                    ...
                    a
                        ...
                        2 == o.type && 6 == v.ie && a.layero.find('iframe').attr('src', d[0]),
                        4 == o.type ?
                        a.tips() :
                        (a.offset(),
            ...
            (t.pt.auto = function(e) {
                var t = this.config,
                    ...
                    (('' === t.area[0] || 'auto' === t.area[0]) &&
                        0 < t.maxWidth &&
                        (v.ie && v.ie < 8 && t.btn && i.width(i.innerWidth()), i.outerWidth() > t.maxWidth) &&
                        i.width(t.maxWidth), [i.innerWidth(), i.innerHeight()]),
            ...
            (t.pt.tips = function() {
                ...
                e.tips[1] || o.remove(),
                    ...
                    3 === n ?
                    0 < a.top - g.scrollTop() + a.height + i[1] + 16 - g.height() && a.where[0]() :
                    ...
                    .on('click', function() {
                        ...
                        t.attr('disabled') ||
                            (o.btnAsync ?
                                ...
                                o.btn1(n.index, a, n) :
                                v.close(n.index) :
                                !1 !== (o['btn' + (i + 1)] && o['btn' + (i + 1)](n.index, a, n)) &&
                                v.close(n.index));
                    }),
            ...
            (f.reselect = function() {
                h.each(h('select'), function(e, t) {
                    var i = h(this);
                    i.parents('.' + u[0])[0] ||
                        (1 == i.attr('layer') && h('.' + u[0]).length < 1 && i.removeAttr('layer').show());
                });
            }),
            (t.pt.IE6 = function(e) {
            ...
            (f.restScrollbar = function(e) {
                u.html.attr('layer-full') == e &&
                    (u.html[0].style[u.html[0].style.removeProperty ? 'removeProperty' : 'removeAttribute'](
                            'overflow'
                        ),
            ...
            (f.promiseLikeResolve = function(e) {
                var t = h.Deferred();
                return (
                    e && 'function' == typeof e.then ? e.then(t.resolve, t.reject) : t.resolve(e), t.promise()
                );
            }),
            ...
            (v.min = function(e, t) {
                ...
                'min' !== c &&
                    ('max' === c && v.restore(e),
                        ...
                        (o = (a = 'string' == typeof(o = l.attr('minLeft'))) ? o : 181 * f.minStackIndex + 'px'),
                        (s = l.css('position')),
                        ...
                        (o = 0),
                        t.minStack &&
                        ((r.left = o), (r.top = g.height() - n), a || f.minStackIndex++, l.attr('minLeft', o)),
                        l.attr('position', s),
                        v.style(e, r, !0),
                        i.hide(),
            ...
            (v.restore = function(e) {
                ...
                t.removeData('maxminStatus'),
                    ...
                    r !== m &&
                    (n.removeData(l), (o === f.type[2] ? n.children('iframe') : n).css({ height: r })),
                    i.show();
            }),
            (v.full = function(t) {
                var i = h('#' + u[0] + t),
                            ...
                            var o = {
                                ...
                                e = function() {
                                    ...
                                    'function' == typeof f.end[s] && f.end[s](),
                                        ...
                                        'function' == typeof r && r(),
                                        f.events.resize[s] &&
                                        (g.off('resize', f.events.resize[s]), delete f.events.resize[s]);
                                },
                                t = h('#' + u.SHADE + s);
        ...
        if ((n = h.extend(!0, { toolbar: !0, footer: !0 }, n)).photos) {
                ...
                if (
                    (e ||
                        c.on('click', n.img, function() {
                            ...
                            v.photos(
                                h.extend(n, { photos: { start: e, data: o, tab: n.tab }, full: n.full }), !0
                            );
                        }), !e)
                )
                    return;
            ...
            (s.keyup = function(e) {
                ...
                s.end ||
                    ((t = e.keyCode),
                        e.preventDefault(),
                        37 === t ? s.imgprev(!0) : 39 === t ? s.imgnext(!0) : 27 === t && v.close(s.index));
            }),
            (s.tabimg = function(e) {
                if (!(o.length <= 1))
                    return (i.start = s.imgIndex - 1), v.close(s.index), v.photos(n, !0, e);
            }),
                ...
                s.main.find('.layui-layer-photos-prev').on('click', function(e) {
                    ...
                    e.off('click').on('click', '*[toolbar-event]', function() {
                        ...
                        switch (e.attr('toolbar-event')) {
                            case 'rotate':
                                (s.image.rotate =
                                    ((s.image.rotate || 0) + Number(e.attr('data-option'))) % 360),
                    ...
                    a && (n.anim = -1),
                        (s.index = v.open(
                            h.extend({
                                    ...
                                    area:
                                        ((e = [e.width, e.height]),
                                            (t = [h(p).width() - 100, h(p).height() - 100]), !n.full &&
                                            (t[0] < e[0] || t[1] < e[1]) &&
                                            ((t = [e[0] / t[0], e[1] / t[1]])[1] < t[0] ?
                                                ((e[0] = e[0] / t[0]), (e[1] = e[1] / t[0])) :
                                                t[0] < t[1] && ((e[0] = e[0] / t[1]), (e[1] = e[1] / t[1]))), [e[0] + 'px', e[1] + 'px']),
                                    title: !1,
                                    shade: [0.9, m, 'unset'],
                                    shadeClose: !0,
                                    closeBtn: !1,
                                    ...
                                    content: '<div class="layer-layer-photos-main"><img src="' +
                                        o[r].src +
                                        '" alt="' +
                                        i +
                                        '" layer-pid="' +
        ...
        e = {
            fixbar: function(i) {
                var o,
                    ...
                    a = s(document),
                    c =
                    ((i = s.extend(!0, { target: 'body', bars: [], default: !0, margin: 160, duration: 320 },
                            i
                        )),
                        s(i.target)),
                ...
                layui.each(i.bars, function(t, e) {
                        ...
                        n
                            ...
                            n.on('click', function() {
                                ...
                                'top' === t &&
                                    ('body' === i.target ? s('html,body') : u).animate({ scrollTop: 0 }, i.duration),
                    ...
                    (e = (function e() {
                        return (
                            u.scrollTop() >= i.margin ? t || (o.show(), (t = 1)) : t && (o.hide(), (t = 0)), e
                        );
                    })()),
            ...
            countdown: function(i) {
                ...
                var o = arguments,
                    r =
                    (1 < o.length &&
                        ((i.date = new Date(o[0])), (i.now = new Date(o[1])), (i.clock = o[2])), {
                            options: i,
                            clear: function() {
            ...
            on: function(i, o, t) {
                ...
                var e,
                    n = ((t = s.extend({ elem: 'body', trigger: 'click' },
                ...
                if (n[0])
                    return (
                        ...
                        (a = n.data(a)),
                        (e = i + '_' + t.trigger),
                        (o = a.events[e] = s.extend(!0, a.events[e], o)),
...
layui.define(['jquery', 'laytpl', 'lay', 'util'], function(e) {
    ...
    (T.prototype.init = function(e, i) {
        ...
        return 1 < a.length ?
            (layui.each(a, function() {
                ...
                t) :
            (c.extend(n, lay.options(a[0])), !e && a.attr(y) ?
                ...
                ((n.elem = c(n.elem)),
                    ...
                    (n.show ||
                        ('reloadData' === i && t.mainElem && n.target.find(t.mainElem.get(0)).length)) &&
                    t.render(i),
                    void t.events()));
    }),
    (T.prototype.render = function(e) {
        var i,
                ...
                return (
                    layui.each(e, function(e, i) {
                        var t,
                            ...
                            l =
                            ((o = p.escape(i[s.title])),
                                (l = i.templet || d.templet),
                                (o = l ? ('function' == typeof l ? l(i) : m(l).render(i)) : o)),
                            o =
                        ...
                        ((l = c(
                            ...
                            n &&
                            ((a = c('<div class="layui-panel layui-menu-body-panel"></div>')),
                                (t = c('<ul></ul>')),
                                'parent' === o ?
                                (a.append(u(t, i[s.children])), l.append(a)) :
                                l.append(u(t, i[s.children]))),
                            r.append(l));
                    }),
                    r
                );
            ...
            ((n = c('<ul class="layui-menu layui-dropdown-menu"></ul>')),
                0 < d.data.length ?
                u(n, d.data) :
                n.html('<li class="layui-menu-item-none">\u6682\u65e0\u6570\u636e</li>'),
                n),
            a = g.findMainElem(d.id);
        'reloadData' === e && a.length ?
            (i = l.mainElem = a).html(n) :
            ((i = l.mainElem = c(t)).append(n),
            ...
            l.position(),
            (h.thisId = d.id),
            i.find('.layui-menu').on(o, function(e) {
                layui.stope(e);
            }),
            i.find('.layui-menu li').on('click', function(e) {
                ...
                t.disabled ||
                    (n && !a) ||
                    '-' === t.type ||
                    (!1 === ('function' == typeof d.click ? d.click(t, i, e) : null) || n || l.remove(),
                        layui.stope(e));
            }),
    ...
    (g.spread = function(e, i) {
        ...
        t.is(':animated') ||
            (n ?
                (e.removeClass(l).addClass(d), t.hide().stop().slideDown(200, a)) :
                (t.stop().slideUp(200, a), e.removeClass(d).addClass(l)),
                n &&
                i &&
    ...
    n.on('resize', function() {
            if (h.thisId) {
                ...
                if (e)
                    return (!((e.mainElem && !e.mainElem[0]) || !c('.' + a)[0]) &&
                        void('contextmenu' === e.config.trigger ? e.remove() : e.position())
                    );
            }
        }),
        lay(i).on(
...
layui.define(['jquery', 'lay'], function(e) {
    ...
    (t.prototype.render = function() {
        ...
        var t,
            ...
            '">' +
            (a.tips ?
                '<div class="' + L + '" ' + (a.tipsAlways ? '' : 'style="display:none;"') + '></div>' :
                '') +
        ...
        function v(e) {
            'vertical' === a.type ?
                n.elemTemp
                .find('.' + L)
                .css({ bottom: e + '%', 'margin-bottom': '20px', display: 'inline-block' }) :
    ...
    (t.prototype.slide = function(e, t, i) {
        var u = this,
            ...
            h = function(e, t, i) {
                (e =
                    (e =
                        100 < (e = 100 < Math.ceil(e) * m ? Math.ceil(e) * m : Math.round(e) * m) ? 100 : e) <
                    0 ?
                    0 :
                    e),
        ...
        d.find('.' + M).each(function(o) {
                ...
                r.on('mousedown touchstart', function(e) {
                    ...
                    (a = function() {
                        n && n(b.touchEventsSupported() ? 1e3 : 0),
                            ...
                            (t[0].removeEventListener(
                                    'touchmove',
                                    i, !!b.passiveSupported && { passive: !1 }
                                ),
                    ...
                    x('#LAY-slider-moving')[0] || x('body').append(g),
                        ...
                        b.touchEventsSupported() &&
                        (t[0].addEventListener('touchmove', i, !!b.passiveSupported && { passive: !1 }),
                            ...
                            (((t =
                                        (t =
                                            (t =
                                                ...
                                                e.clientX - i.offset().left - x(window).scrollLeft()) < 0 ?
                                            0 :
                                            t) > p() ?
                                        p() :
                                        t) /
        ...
        var n = function() {
            var e = this.value,
                e =
                ((e = (e = (e = isNaN(e) ? 0 : e) < c.min ? c.min : e) > c.max ? c.max : e),
...
layui.define(['jquery', 'lay'], function(e) {
        ...
        F = function(e) {
            ...
            return (
                ...
                ((e = ((t % 60) * ((i = e) - (n = ((255 - n) * e) / 255))) / 60),
                    ...
                    t < 360 ?
                    ((o.r = i), (o.g = n), (o.b = i - e)) :
                    ((o.r = 0), (o.g = 0), (o.b = 0))), { r: Math.round(o.r), g: Math.round(o.g), b: Math.round(o.b) }
            );
        },
        H = function(e) {
            var e = F(e),
                ...
                [
                    ...
                    ((o = ''),
                        ...
                        ((o = i.color),
                            ...
                            ((i.alpha && 'rgb' == i.format) || (o = '#' + H(j(L(i.color))))),
                            'background: ' + o) :
                        o) +
                    '">',
    ...
    (s.prototype.removePicker = function(e) {
        ...
        return (
            e[0] && (e.remove(), delete r.thisId, 'function' == typeof i.close) && i.close(this.color),
            this
        );
    }),
        ...
        n
            ...
            ((e = j(L(n))),
                ...
                ((o = L(n)),
                    ...
                    (t.find('input').val('rgba(' + o.r + ', ' + o.g + ', ' + o.b + ', 1)'),
        ...
        o.on('mousedown', function(e, i) {
            ...
            d.on('mousedown', function(e) {
                var i = e.clientY - x(this).offset().top + W.scrollTop(),
                    ...
                    o =
                    ((i = i < 0 ? 0 : i) > this.offsetHeight && (i = this.offsetHeight),
                        ((o = (o = o < 0 ? 0 : o) > this.offsetWidth ? this.offsetWidth : o) / 260) * 100),
                    i = 100 - (i / 180) * 100;
                y(p, (g = o), (h = i), v),
                    layui.stope(e),
                    e.preventDefault(),
    ...
    (s.prototype.select = function(e, i, o, t) {
        ...
        this.elemPicker.find('.' + I).css('top', e),
            ...
            this.elemPicker
            .find('.' + M)
            .css({ top: (o / r.offsetHeight) * 100 + '%', left: (i / r.offsetWidth) * 100 + '%' });
    }),
            ...
            o = {
                ...
                confirm: function(e, i) {
                    ...
                    1 < l.indexOf(',') ?
                        ...
                        (3 === (n = -1 < (n = l).indexOf('#') ? n.substring(1) : n).length &&
    ...
    a.on(i, function(e) {
        ...
        (n.getThis = function(e) {
            var i = n.that[e];
            return (
                i || o.error(e ? t + " instance with ID '" + e + "' not found" : 'ID argument required'), i
            );
        }),
        (r.render = function(e) {
            e = new s(e);
    ...
    var u = layui.$,
        ...
        w = {
            tabClick: function(t) {
                ...
                if (!t.force) {
                    ...
                    if (!1 ===
                        layui.event.call(this, r, 'tabBeforeChange(' + s + ')', {
                            elem: e,
                            from: { index: a.parent().children('li').index(t), id: t.attr('lay-id') },
                            to: { index: c, id: o },
                        })
                    )
                        return;
                ...
                l ||
                    ...
                    (a.addClass(y).siblings().removeClass(y),
                        (o ? (t = (t = i.filter('[lay-id="' + o + '"]')).length ? t : i.eq(c)) : i.eq(c))
                        .addClass(f)
                        .siblings()
                        .removeClass(f)),
                    layui.event.call(this, r, 'tab(' + s + ')', { elem: e, index: c, id: o });
            },
            tabDelete: function(t) {
                ...
                if (!t.force &&
                    !1 ===
                    layui.event.call(i[0], r, 'tabBeforeDelete(' + n + ')', { elem: e, index: a, id: s })
                )
                    return;
                i.hasClass(y) &&
                    (i.next()[0] && i.next().is('li') ?
                        w.tabClick.call(i.next()[0], { index: a + 1 }) :
                        i.prev()[0] && i.prev().is('li') && w.tabClick.call(i.prev()[0], null, a - 1)),
                    i.remove(),
                    (s ?
                    ...
                    layui.event.call(this, r, 'tabDelete(' + n + ')', { elem: e, index: a, id: s });
            },
                    ...
                    e &&
                        ...
                        a.find('li').each(function() {
                            ...
                            i.find('.' + o)[0] ||
                                ...
                                ((t = u('<i class="layui-icon layui-icon-close layui-unselect ' + o + '"></i>')).on(
                                        'click',
                                        function(t) {
                        ...
                        (a.prop('scrollWidth') > a.outerWidth() + 1 ||
                            (a.find('li').length && a.height() > (e = a.find('li').eq(0).height()) + e / 2) ?
            ...
            clickThis: function() {
                ...
                if (
                    ...
                    var n = p + 'ed',
                        s = !e.hasClass(n),
                        o = function() {
                            u(this).css({ display: '' }), i.children('.' + b).css({ opacity: 0 });
                        };
            ...
            collapse: function() {
                ...
                'string' == typeof e.attr('lay-accordion') &&
                    ...
                    i.html(n ? '&#xe61a;' : '&#xe602;'),
                    layui.event.call(this, r, 'collapse(' + l + ')', { title: t, content: a, show: n });
            },
        },
        a =
                                ...
                                (t || u(h + a)).each(function(t) {
                                    ...
                                    l[0] && l.remove(),
                                        ...
                                        e.find('a').each(function() {
                                            ...
                                            t.siblings('.' + m)[0] &&
                                                !t.children('.' + g)[0] &&
                                                t.append('<i class="layui-icon layui-icon-down ' + g + '"></i>'),
...
layui.define(['lay', 'layer'], function(e) {
    ...
    (D.prototype.render = function(e) {
        ...
        return 1 < n.length ?
            (layui.each(n, function() {
                ...
                t) :
            (F.extend(i, a.options(n[0], { attr: n.attr('lay-data') ? 'lay-data' : null })), !e && n[0] && n.data(s) ?
    ...
    (D.prototype.initIE = function() {
        var i,
            e = this.config,
            t = F(
                '<iframe id="' + E + '" class="' + E + '" name="' + E + '" frameborder="0"></iframe>'
            ),
            n = F(
                [
                    '<form target="' +
    ...
    (D.prototype.upload = function(e, t) {
                    ...
                    i = function(i) {
                        ...
                        if (
                            (layui.each(f.data, function(e, t) {
                                    (t = 'function' == typeof t ? (i.unified ? t() : t(i.index, i.file)) : t),
                                    n.append(e, t);
                                }),
                                i.unified)
                        )
        ...
        if (0 !== y.length) {
            switch (f.accept) {
                ...
                case 'video':
                    layui.each(y, function(e, t) {
                        if (!RegExp('.\\.(' + (v || 'avi|mp4|wma|rmvb|rm|flash|3gp|flv') + ')$', 'i').test(
                                escape(t)
                            ))
                            return (i = !0);
                    });
                ...
                default:
                    layui.each(y, function(e, t) {
                        if (!RegExp('.\\.(' + (v || 'jpg|png|gif|bmp|jpeg|svg|webp') + ')$', 'i').test(
                                escape(t)
                            ))
                            return (i = !0);
                    });
                ...
                if (0 < f.size && !(R.ie && R.ie < 10))
                    if (
                        (layui.each(c(), function(e, t) {
                                t.size > 1024 * f.size &&
                                    ((t = 1 <= (t = f.size / 1024) ? t.toFixed(2) + 'MB' : f.size + 'KB'),
                                        (l.value = ''),
                                        (o = t));
                            }),
                            o)
    ...
    (o.getThis = function(e) {
        var t = o.that[e];
        return (
            t || hint.error(e ? i + " instance with ID '" + e + "' not found" : 'ID argument required'),
            t
        );
    }),
    (w.render = function(e) {
...
layui.define(['lay', 'layer', 'util'], function(e) {
    ...
    var _ = layui.$,
            ...
            this.config = {
                verify: {
                    ...
                    date: function(e) {
                        if (
                            e &&
                            !/^(\d{4})[-\/](\d{1}|0\d{1}|1[0-2])([-\/](\d{1}|0\d{1}|[1-2][0-9]|3[0-1]))*$/.test(e)
                        )
                            return '\u65e5\u671f\u683c\u5f0f\u4e0d\u6b63\u786e';
                    },
                    identity: function(e) {
        ...
        ((t.prototype.set = function(e) {
                    ...
                    layui.each(e, function(e, t) {
                        ...
                        t.name &&
                            (/^.*\[\]$/.test(t.name) &&
                                ...
                                (l[i || t.name] =
                                    'SELECT' === this.tagName && 'string' == typeof this.getAttribute('multiple') ?
                                    a.val() || [] :
                                    this.value));
                    }),
                    l
                    ...
                    n = {
                        input: function(e) {
                                ...
                                (i.autocomplete && e.attr('autocomplete', i.autocomplete),
                                    function(e, t) {
                                        var i = e.val(),
                                            ...
                                            c = 'init' === t;
                                        isNaN(a) ||
                                            ('click' === t && (a = !!_(this).index() ? a - n : a + n),
                                                (t = function(e) {
                                                ...
                                                o ||
                                                (c || (r <= (a = a <= l ? l : a) && (a = r)),
                                                    0 === s ? (a = parseInt(a)) : 0 < s && (a = a.toFixed(s)),
                                                    e.val(a)),
                                                e[(a < l || r < a) && !o ? 'addClass' : 'removeClass'](
                                            ...
                                            ((n = {
                                                ...
                                                }).increment[r <= a && !o ? 'addClass' : 'removeClass'](O),
                                                n.decrement[a <= l && !o ? 'addClass' : 'removeClass'](O));
                                    });
                            a.find('input[lay-affix],textarea[lay-affix]').each(function() {
                                var r = _(this),
                                    ...
                                    d = function(e, t) {
                                        (e = _(e))[0] && e[_.trim(t) ? 'removeClass' : 'addClass'](j);
                                    },
                                    n = function(i) {
                                        i = _.extend({}, h[s] || { value: s }, i, lay.options(r[0]));
                                        var a,
                                            t = _('<div class="' + u + '">'),
                                        ...
                                        l[0] ?
                                            ((n = l.find('.' + u))[0] && n.remove(),
                                                ...
                                                r.css('padding-right', function() {
                                                    return (
                                                        (r.closest('.layui-input-group')[0] ? 0 : l.outerWidth()) +
                                                        t.outerWidth()
                                                    );
                                                })) :
                                            ...
                                            e.on('click', function() {
                                                ...
                                                _(this).hasClass(O) ||
                                                    ('function' == typeof i.click && i.click.call(this, r, i),
                                                        layui.event.call(this, N, 'input-affix(' + e + ')', {
                                                            elem: r[0],
                                                            affix: s,
                                                            options: i,
                                                        }));
                        ...
                        select: function(e) {
                            var f = '\u8bf7\u9009\u62e9',
                                C = 'layui-form-select',
                                w = 'layui-select-none',
                                T = 'layui-select-create-option',
                                p = 'layui-select-panel-elem-data',
                                e = e || a.find('select'),
                                y = function(n, e, t, i, u, a) {
                                    var l,
                                        d,
                                        r,
                                        s,
                                        ...
                                        ((d =
                                            ...
                                            (c = function() {
                                                ...
                                                v.parent().addClass(C + 'ed'),
                                                    ...
                                                    i.removeClass($),
                                                    0 <= k && i.eq(k).addClass($),
                                                    e + t > S.height() && t <= e && n.addClass(C + 'up'),
                                                    f(),
                                                    o &&
                                                    g
                                            ...
                                            (h = function(e) {
                                                v.parent().removeClass(C + 'ed ' + C + 'up'),
                                                    m.blur(),
                                                    u && g.children('.' + T).remove(),
                                                    l && l(),
                                                    a && (n.detach(), _(window).off('resize.lay_select_resize')),
                                                    e ||
                                                    p(m.val(), function(e) {
                                                        var t = y[0].selectedIndex;
                                                        e &&
                                                            ((x = _(y[0].options[t]).html()),
                                            ...
                                            v.on('click', function(e) {
                                                (v.parent().hasClass(C + 'ed') ? h : c)(), g.find('.' + w).remove();
                                            }),
                                                ...
                                                var e = n.keyCode,
                                                    ...
                                                    (9 === e && h(),
                                                        function(e) {
                                                            ...
                                                            var t,
                                                                i,
                                                                a = g.children('dd:not(.' + j + ',.' + O + ')');
                                                            a.length &&
                                                                ((t = a.length - 1),
                                                                    (i = -1),
                                                                    layui.each(a, function(e, t) {
                                                                        if (_(t).hasClass($)) return (i = e), !0;
                                                                    }),
                                                                    (e =
                                                                        'prev' === e ? (i - 1 < 0 ? t : i - 1) : t < i + 1 ? 0 : i + 1),
                                                                    a.eq(e).addClass($).siblings().removeClass($),
                                                                    f());
                                                        });
                                                38 === e && t('prev'),
                                                    40 === e && t('next'),
                                                    13 === e && (n.preventDefault(), g.children('dd.' + $).trigger('click'));
                                            })
                                            .on('paste', function() {
                                                c();
                                            }),
                                                ...
                                                var r,
                                                    ...
                                                    (d.caseSensitive || (n = n.toLowerCase()),
                                                        ...
                                                        layui.each(t, function() {
                                                            ...
                                                            ('' === n || 'blur' === l ? n !== t : a) && s++,
                                                            'keyup' === l && e[(u ? a && !i : a) ? 'addClass' : 'removeClass'](j);
                                                        }),
                                                        'keyup' === l &&
                                                        layui.each(b, function() {
                                                            var e = _(this),
                                                            ...
                                                            e[
                                                                (t = u ? t.not('.' + T) : t).length == t.filter('.' + j).length ?
                                                                'addClass' :
                                                                'removeClass'
                                                            ](j);
                                                        }),
                                                            ...
                                                            (p(
                                                                    ...
                                                                    function(e, t) {
                                                                        ...
                                                                        u
                                                                            ...
                                                                            g.children('.' + T).remove() :
                                                                            (t = g.children('.' + T))[0] ?
                                                                            t.attr('lay-value', n).html(A.escape(n)) :
                                                                            ((t = _('<dd>')
                                                                                    .addClass(T)
                                                                                    .attr('lay-value', n)
                                                                                    .html(A.escape(n))),
                                                                                (a = (i = g.children().eq(0)).hasClass(
                                                                                    'layui-select-tips'
                                                                                )),
                                                                                i[a ? 'after' : 'before'](t)) :
                                                                            e ?
                                            ...
                                            g.on('click', 'dd', function() {
                                                ...
                                                return (
                                                    t.hasClass(O) ||
                                                    (t.hasClass('layui-select-tips') ?
                                                        m.val('') :
                                                        (m.val(t.text()), t.addClass($)),
                                                        u &&
                                                        t.hasClass(T) &&
                                                        (g.append(t.removeClass(T)),
                                                            (e = _('<option>').attr('value', i).text(t.text())),
                                                            y.append(e)),
                                                        t.siblings().removeClass($),
                                                        y.val(i).removeClass('layui-form-danger'),
                                                        layui.event.call(this, N, 'select(' + a + ')', {
                                                            elem: y[0],
                                                            value: i,
                                                            othis: n,
                                                        }),
                            ...
                            e.each(function(e, t) {
                                ...
                                var s,
                                    ...
                                    t = (t && !t.value && t.innerHTML) || f,
                                    h = _(
                                        [
                                            '<div class="' + (c ? '' : 'layui-unselect ') + C,
                                            (n ? ' layui-select-disabled' : '') + '"></div>',
                                        ].join('')
                                    ),
                                    t = _(
                                        [
                                                ...
                                                layui.each(r, function(e, t) {
                                                    ...
                                                    0 !== e || t.value || 'optgroup' === i ?
                                                        ...
                                                        s.push(
                                                            ...
                                                            _.trim(t.innerHTML || f) +
                                                            '</dd>'
                                                        );
                                                }),
                                                0 === s.length &&
                                                s.push(
                                                    '<dd lay-value="" class="' + O + '">\u6ca1\u6709\u9009\u9879</dd>'
                                                ),
                                                s.join('') + '</dl>'),
                                        ].join('')
                                    );
                                a[0] && (d && (o = a.data(p)) && o.remove(), a.remove()),
                                    d ?
                                    (h.append(t),
                                        i.after(h),
                                        (o = _('<div class="' + C + ' layui-select-panel-wrap"></div>').append(r)),
                                        h.data(p, o),
                                        y.call(this, o, t, n, c, u, d)) :
                        ...
                        checkbox: function(e) {
                            ...
                            e.each(function(e, t) {
                                var i = _(this),
                                    ...
                                    n = A.escape(_.trim(t.title || (t.title = i.attr('lay-text') || ''))),
                                    l = this.disabled,
                                    r = c[a] || c.checkbox,
                                    s = i.next('.' + r[0]),
                                    o = (s[0] && s.remove(), []);
                                if (
                                    (i.next('[lay-checkbox]')[0] &&
                                        ((s = i.next()), (n = s.html() || ''), 1 < s[0].attributes.length) &&
                                    ...
                                    return i.show();
                                d &&
                                    (p.call(t, 'lay-form-sync-checked', t.checked),
                                        t.checked || p.call(t, 'lay-form-sync-indeterminate', t.indeterminate));
                                l = _(
                                    [
                                        '<div class="layui-unselect ' + r[0],
                                        t.checked ? ' ' + r[1] : '',
                                        l ? ' layui-checkbox-disabled ' + O : '',
                                        '"',
                                        a ? ' lay-skin="' + a + '"' : '',
                                        '>',
                                        (s = {
                                            checkbox: [
                                                ...
                                                '<div></div>',
                                                '<i class="layui-icon ' +
                                                ('primary' === a && !t.checked && i.get(0).indeterminate ?
                                                    c.SUBTRA :
                                                    'layui-icon-ok') +
                                                '"></i>',
                                            ].join(''),
                                    ...
                                    function(t, i) {
                                        ...
                                        t.on('click', function() {
                                            ...
                                            u.syncAppearanceOnPropChanged(this, 'checked', function() {
                                                ...
                                                n &&
                                                    ((e = (
                                                            t.next('*[lay-checkbox]')[0] ? t.next().html() : a.attr('title') || ''
                                                        ).split('|')),
                                                        t.children('div').html((!this.checked && e[1]) || e[0])),
                        ...
                        radio: function(e) {
                            ...
                            e.each(function(e, t) {
                                var i = _(this),
                                    ...
                                    l = i.attr('lay-skin');
                                if ('string' == typeof i.attr('lay-ignore')) return i.show();
                                d && p.call(t, 'lay-form-sync-checked', t.checked), a[0] && a.remove();
                                var a = A.escape(t.title || ''),
                                    r = [],
                                    s =
                                    (i.next('[lay-radio]')[0] &&
                                        ((a = (s = i.next()).html() || ''), 1 < s[0].attributes.length) &&
                                        layui.each(s[0].attributes, function(e, t) {
                                ...
                                i.after(s),
                                    function(i) {
                                        ...
                                        i.on('click', function() {
                                                ...
                                                a[0].disabled ||
                                                    ((a[0].checked = !0),
                                                        layui.event.call(a[0], N, 'radio(' + e + ')', {
                                                            elem: a[0],
                                                            value: a[0].value,
                                                            othis: i,
                                                        }));
                                            ...
                                            u.syncAppearanceOnPropChanged(this, 'checked', function() {
                                                ...
                                                t.checked ?
                                                    (i.addClass(o + 'ed'),
                                                        ...
                                                        (e = a
                                                            .parents(h)
                                                            .find('input[name=' + t.name.replace(/(\.|#|\[|\])/g, '\\$1') + ']')),
                                                        layui.each(e, function() {
            ...
            (t.prototype.syncAppearanceOnPropChanged = d ?
                ...
                function(e, t, i) {
                    ...
                    Object.defineProperty(
                        ...
                        lay.extend({}, a, {
                            ...
                            set: function(e) {
                                p.call(this, 'lay-form-sync-' + t, e), i.call(this);
                            },
                        })
                    );
                } :
                                    ...
                                    layui.each(t, function(e, t) {
                                        ...
                                        if (a) {
                                            ...
                                            if (('required' === t && (i = s.attr('lay-reqtext') || i), n))
                                                return (
                                                    'tips' === o ?
                                                    f.tips(i, 'string' != typeof s.attr('lay-ignore') && l ? s.next() : s, {
                                                        tips: 1,
                                                    }) :
                                                    'alert' === o ?
                                                    f.alert(i, { title: '\u63d0\u793a', shadeClose: !0 }) :
                                                    /\b(string|number)\b/.test(typeof i) && f.msg(i, { icon: 5, shift: 6 }),
                                                    setTimeout(function() {
            ...
            (t.prototype.submit = function(e, t) {
                ...
                return (!!r.validate(l) &&
                    ((i = r.getValue(null, n)),
                        ...
                        layui.event.call(this, N, 'submit(' + e + ')', l))
                );
            }));
    ...
    _(function() {
        ...
        t.on('submit', h, i).on('click', '*[lay-submit]', i),
        e(N, r);
});
layui.define(['lay', 'laytpl', 'laypage', 'form', 'util'], function(s) {
    ...
    var f = layui.$,
        ...
        C = function(e) {
            ...
            return (
                t ||
                b.error(e ? "The table instance with ID '" + e + "' not found" : 'ID argument required'),
                t || null
            );
        },
        l = function(e) {
        ...
        ((n.prototype.config = {
            ...
            (n.prototype.render = function(e) {
                ...
                if (
                    ((w.that[i] = t),
                        ((w.config[i] = a).request = f.extend({ pageName: 'page', limitName: 'limit' },
                            a.request
                        )),
                        (a.response = f.extend({
                                statusName: 'code',
                ...
                t.setInit(),
                    ...
                    ((i = a.height.split('-')),
                        ...
                        (t.parentDiv = i.join('-')),
                        (a.height = f(t.parentDiv).height() - (parseFloat(t.parentHeightGap) || 0))) :
                    'function' == typeof a.height &&
                    ((t.customHeightFunc = a.height), (a.height = t.customHeightFunc()));
                var l,
                    e = a.elem,
                    i = e.next('.' + D),
                    n = (t.elem = f('<div></div>'));
                n
                    .addClass(
                        ((l = [D, D + '-' + t.index, 'layui-form', 'layui-border-box']),
                    ...
                    ((a = '.layui-table-view-' + n + ' .layui-table-body .layui-table tr'),
                        ...
                        layui.each(t, function(e, t) {
                            if ('height' === (t = t.split(':'))[0])
                                return (t = parseFloat(t[1])), isNaN(t) || (i = t - 1 + 'px'), !0;
                        }),
                        layui.each(
                            [
                                '{' + e + '}',
                                    ...
                                    (0, e.openPanel)({
                                        list:
                                                ...
                                                o.eachCols(function(e, t) {
                                                    t.field &&
                                                        ...
                                                        a.push(
                                                            ...
                                                            ' title="' +
                                                            v.escape(
                                                                f('<div>' + (t.fieldTitle || t.title || t.field) + '</div>').text()
                                                            ) +
                                            ...
                                            i.on('checkbox(LAY_TABLE_TOOL_COLS)', function(e) {
                                                ...
                                                i.key &&
                                                    ((i.hide = !t),
                                                        o.elem.find('*[data-key="' + a + '"]')[t ? 'removeClass' : 'addClass'](W),
                            ...
                            exports: {
                                ...
                                onClick: function(e) {
                                    var t = e.data,
                                        ...
                                        e = e.elem;
                                    if (!t.length)
                                        return g.tips('\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e', e, { tips: 3 });
                                    x.ie ?
                                        g.tips(
                ...
                'object' == typeof e.defaultToolbar &&
                    ((l = []),
                        (e.defaultToolbar = f.map(e.defaultToolbar, function(e, t) {
                            ...
                            return (
                                i &&
                                (!(i = i.name && n[i.name] ? f.extend({}, n[i.name], i) : i).name &&
                                    a &&
                                    (i.name = e),
                                    l.push(
            ...
            (n.prototype.renderPagebar = function() {
                ...
                t.pagebar &&
                    ((e = f(t.pagebar).html() || '') && a.append(m(e).render(t)), this.layPage.append(a));
            }),
            ...
            (n.prototype.setColsWidth = function(e) {
                                    ...
                                    layui.each(n, function(e, t) {
                                        ...
                                        t
                                            ...
                                            (o ?
                                                ...
                                                ((a = t.width || 0),
                                                    /\d+%$/.test(a) ?
                                                    l < (a = (a = (parseFloat(a) / 100) * u) < i ? i : a) && (a = l) :
                                                    a ?
                                                    'normal' === t.type &&
                                                    (a < i && (t.width = a = i), l < a) &&
                                                    (t.width = a = l) :
                ...
                o.eachCols(function(e, a) {
                    ...
                    o.cssRules(n.key, function(e) {
                        ...
                        (e.style.width = a + 'px'), !p && h && y.width(o.getContentWidth(l)),
                            o.layMain.prop('offsetHeight') > o.layMain.prop('clientHeight') &&
                ...
                var e,
                    ...
                    r = function() {
                        'object' == typeof o.initSort &&
                            n.sort({ field: o.initSort.field, type: o.initSort.type, reloadType: l.type });
                    },
                    c = function(e, t) {
                        n.setColsWidth(),
                            n.loading(!1),
                ...
                'function' == typeof o.before && o.before(o),
                    ...
                    (((e = {})[d.dataName] = k.cache[n.key]),
                        (e[d.countName] = o.url ?
                            ...
                            e[d.dataName].length :
                            o.data.length),
                        'object' == typeof o.totalRow && (e[d.totalRowName] = f.extend({}, n.totalRow)),
                        n.renderData({ res: e, curr: i, count: e[d.countName], type: l.type, sort: !0 }),
                        c(e, 'renderData')) :
                    o.url ?
                    ((t = {}),
                        ...
                        f.ajax({
                            ...
                            success: function(e) {
                                var t, a;
                                (e = 'function' == typeof o.parseData ? o.parseData(e) || e : e)[d.statusName] !=
                                d.statusCode ?
                                    n.errorView(
                                        e[d.msgName] ||
                    ...
                    ((e = {}),
                        ...
                        'object' == typeof o.totalRow && (e[d.totalRowName] = f.extend({}, o.totalRow)),
                        (n.totalRow = e[d.totalRowName]),
                        n.renderData({ res: e, curr: i, count: e[d.countName], type: l.type }),
                        r(),
                        c(e, l.type));
            }),
                            ...
                            s.eachCols(function(e, l) {
                                ...
                                l.colGroup ||
                                    ((e = [
                                            ...
                                            '" ' +
                                            ((e = []),
                                                (t = 'function' == typeof l.edit ? l.edit(o) : l.edit) &&
                                                e.push('data-edit="' + t + '"'),
                                                ...
                                                e.join(' ')) +
                                            ' class="' +
                                            ((t = []), l.hide && t.push(W), l.field || t.push(F), t.join(' ')) +
                                            '">',
                                            '<div class="layui-table-cell laytable-cell-' +
            ...
            (n.prototype.renderData = function(e) {
                ...
                return (
                    ...
                    a.layPage
                    .find(P)[!i.page || 0 == n || (0 === d.length && 1 == l) ? 'addClass' : 'removeClass'](y),
                    0 === d.length ?
                    ...
                    (layui.each(e, function(e, i) {
                        ...
                        r.eachCols(function(e, t) {
                            var e = t.field || e,
                                ...
                                ((n = t.totalRowText || ''),
                                    ((l = { LAY_COL: t })[e] = i),
                                    (l = (t.totalRow && T.call(r, { item3: t, content: i, tplData: l })) || n),
                                    a || l),
                                l =
                                'string' == typeof(n = t.totalRow || c.totalRow) ?
                                m(n).render(
                                    f.extend({ TOTAL_NUMS: a || s[e], TOTAL_ROW: o || {}, LAY_COL: t }, t)
                                ) :
                                i,
                                n =
                                (t.field &&
                                    r.dataTotal.push({ field: t.field, total: f('<div>' + l + '</div>').text() }), [
                                        '<td data-field="' +
                                        e +
                                        '" data-key="' +
                                        t.key +
                                        ...
                                        ((n = []),
                                            ...
                                            n.join(' ')) +
                                        ' class="' +
                                        ((a = []), t.hide && a.push(W), t.field || a.push(F), a.join(' ')) +
                                        '">',
                                        '<div class="layui-table-cell laytable-cell-' +
                                        ((i = t.key), 'normal' === t.type ? i : i + ' laytable-cell-' + t.type) +
                                        '"' +
            ...
            (n.prototype.setRowChecked = function(i) {
                ...
                (u &&
                    ...
                    (d = (u = (s = e
                        ...
                        .children(
                            'input[lay-type="' +
                            ({ radio: 'layTableRadio', checkbox: 'layTableCheckbox' }[i.type] || 'checkbox') +
                            '"]:not(:disabled)'
                        )).last()).closest(I)),
            ...
            (n.prototype.sort = function(l) {
                ...
                i.autoSort &&
                    ...
                    ((i.initSort = { field: d, type: l.type }),
                        layui.event.call(l.field, R, 'sort(' + n + ')', f.extend({ config: i }, i.initSort)));
            }),
            ...
            (n.prototype.scrollPatch = function() {
                var e = this,
                    ...
                    n = function(e) {
                        ...
                        a && i ?
                            ...
                            ((t = f('<th class="layui-table-patch"><div class="layui-table-cell"></div></th>'))
                                .find('div')
                                .css({ width: a }),
                                e.find('tr').append(t)) :
                ...
                e.layFixed
                    ...
                    e.layFixRight[
                        k.cache[e.key] && k.cache[e.key].length && 0 < l ? 'removeClass' : 'addClass'
                    ](W),
                ...
                layui.each(e, function(e, t) {
                    ...
                    layui.each(l, function(e, t) {
                        ...
                        r.eachCols(function(e, t) {
                            var a,
                                i = String(t.field || e);
                            (i in l || (('function' == typeof n ? n(i, e) : n) && (t.templet || t.toolbar))) &&
                            ((i = (e = d.children('td[data-field="' + i + '"]')).children(c)),
                                (a = o[t.field]),
                                i.html(T.call(r, { item3: t, content: a, tplData: f.extend({ LAY_COL: t }, o) })),
                                e.data('content', a),
                ...
                var c = this,
                    ...
                    (c.layTool.on('click', '*[lay-event]', function(e) {
                                ...
                                layui.each(s.defaultToolbar, function(e, t) {
                                    if (t.layEvent === a)
                                        return (
                                            ...
                                            t.onClick({ data: l, config: s, openPanel: n, elem: i }), !0
                                        );
                                }),
                                layui.event.call(
                                    this,
                        ...
                        .on('mousemove', function(e) {
                            ...
                            w.eventMoveElem &&
                                ...
                                ((e = t.ruleWidth + e.clientX - t.offset[0]),
                                    (a = w.eventMoveElem.closest('.' + D).attr(N)),
                                    (a = C(a))) &&
                        ...
                        .on('mouseup', function(e) {
                            var t, a, i, l, n;
                            w.eventMoveElem &&
                                ((i = (t = w.eventMoveElem).closest('.' + D).attr(N)), (a = C(i))) &&
                                ((i = t.data('key')),
                                    (l = a.col(i)),
                    ...
                    (c.elem.on('click', 'input[name="layTableCheckbox"]+', function(e) {
                        ...
                        function(e, t) {
                            ...
                            if (!a.data('off')) {
                                ...
                                layui.event.call(this, R, e + '(' + o + ')', y.call(a.children('td')[0], { e: t }));
                            }
                        }),
                    n = function(e, t) {
                        var a, i, l;
                        (e = f(e)).data('off') ||
                            ((l = e.data('field')),
                                ...
                                (((i = f(
                                        'textarea' === i ?
                                        '<textarea class="layui-input ' + M + '" lay-unrow></textarea>' :
                                        '<input class="layui-input ' + M + '" lay-unrow>'
                                    ))[0].value = (l = e.data('content') || a[l]) === undefined || null === l ? '' : l),
                                    e.find('.' + M)[0] || e.append(i),
                                    i.focus(),
                                    t) &&
                                layui.stope(t));
                    },
                    ...
                    a = function(e) {
                        ...
                        t.data('off') ||
                            ...
                            (e ?
                                ...
                                !(a.prop('scrollWidth') > a.prop('clientWidth') || 0 < a.find('br').length) ||
                                s.lineStyle ||
                                a.find('.' + i)[0] ||
                                t.append(
            ...
            (n.prototype.getContentWidth = function(e) {
                ...
                return !(
                    ...
                    t.width - t.paddingLeft - t.paddingRight - t.borderLeftWidth - t.borderRightWidth :
                    t.width :
                    e.width();
            }),
    ...
    (k.checkStatus = function(e) {
        ...
        return (
            ...
            }), { data: i, dataCache: l, isAll: !(!e.length || !i.length) && i.length === e.length - a }
        );
    }),
                                ...
                                k.eachCols(e, function(e, t) {
                                    ...
                                    !1 === t.ignoreExport || (t.field && 'normal' == t.type) ?
                                        ...
                                        (((a = l[t.field]) !== undefined && null !== a) || (a = ''),
                                            ...
                                            n.push((a = '"' + a + '"'))) :
                                        t.field && 'normal' !== t.type && 0 == i && (u[t.field] = !0);
                                }),
                                c.push(n.join(','));
                        }),
                        o &&
        ...
        n &&
            ('boolean' === layui.type(l) ?
                n.eachCols(function(e, t) {
                    ...
                    i.hide != l &&
                        ((i = i.hide = l),
                            n.elem.find('*[data-key="' + a + '"]')[i ? 'addClass' : 'removeClass'](W),
                            n.setParentCol(i, t));
                }) :
...
layui.define(['table'], function(e) {
    ...
    var A = layui.$,
        ...
        j = function(e) {
            ...
            return (
                t ||
                y.error(
                    e ? "The treeTable instance with ID '" + e + "' not found" : 'ID argument required'
                ),
                t || null
            );
        },
        ...
        d = function(d, a, e) {
            var r = j(d),
                o =
                ('reloadData' !== e && (r.status = { expand: {} }), A.extend(!0, {}, r.getOptions(), a)),
                n = o.tree,
            ...
            'reloadData' === e &&
                ...
                ((a.parseData = function() {
                        ...
                        return (
                            ...
                            e.initSort &&
                            e.initSort.type &&
                            layui.sort(a[t], e.initSort.field, 'desc' === e.initSort.type, !0),
                            r.initData(a[t]),
                            a
                        );
                    }),
                ...
                ((a.done = function() {
                        var e,
                            ...
                            (r.updateStatus(null, { LAY_HAS_EXPANDED: !1 }),
                                x(d, c),
                                i.find('[name="layTableCheckbox"][lay-filter="layTableAllChoose"]'));
                        if (
                            (l.length &&
                                ((e = B.checkStatus(d)),
                                    l.prop({
    ...
    (a.prototype.getNodeDataByIndex = function(e, t, a) {
        ...
        for (
            var d = n, r = String(e).split('-'), o = 0, c = i.customName.children; o < r.length; o++
        ) {
            if (a && o === r.length - 1) {
    ...
    var r,
        ...
        J = function(t, a, n, i, l) {
            ...
            var m = y[X],
                ...
                v = (c.updateNodeIcon({ scopeEl: b, isExpand: x, isParent: y[f] }), (y[H] = x), y[s.id]);
                            ...
                            return (
                                ...
                                ((I = A.extend({}, m.where || o.where)),
                                    ...
                                    A.ajax({
                                        ...
                                        headers: _ || {},
                                        success: function(e) {
                                            (e = 'function' == typeof k ? k.call(o, e) || e : e)[w.statusName] !=
                                            w.statusCode ?
                                                ((y[V] = 'error'),
                                                    (y[H] = !1),
                                                    g.html('<i class="layui-icon layui-icon-refresh"></i>')) :
                                                N(e[w.dataName]);
                                        },
                                        error: function(e, t) {
                                            (y[V] = 'error'),
                        ...
                        v.length &&
                            (!o.initSort ||
                                ...
                                layui.each(v, function(e, t) {
                                    S.trs
                                        .eq(e)
                                        .attr({ 'data-index': t[z], 'lay-data-index': t[z], 'data-level': E })
                                        .data('index', t[z]),
                                        S.trs_fixed
                                        .eq(e)
                                        .attr({ 'data-index': t[z], 'lay-data-index': t[z], 'data-level': E })
                    ...
                    ((t = t || 0) ||
                        (d.find('.layui-table-body tr:not([data-level])').attr('data-level', t),
                            layui.each(P.cache[i], function(e, t) {
                                ...
                                t = t[z];
                                d
                                    .find('.layui-table-main tbody tr[data-level="0"]:eq(' + e + ')')
                                    .attr('lay-data-index', t),
                                    d
                                    .find('.layui-table-fixed-l tbody tr[data-level="0"]:eq(' + e + ')')
                                    .attr('lay-data-index', t),
                                    d
                                    .find('.layui-table-fixed-r tbody tr[data-level="0"]:eq(' + e + ')')
                                    .attr('lay-data-index', t);
                            })),
                        null),
                    p = c.name,
                        ...
                        t.hasClass('layui-table-tree-item') ||
                            ((n = i.attr('lay-data-index')) &&
                                ((i = d.find('tr[lay-data-index="' + n + '"]')),
                                    (a = s.getNodeDataByIndex(n))[H] && a[u] && ((y = y || {})[n] = !0),
                                    a[g] &&
                                    i
                                    .find('input[type="checkbox"][name="layTableCheckbox"]')
                                    .prop('indeterminate', !0),
                                    (n = t.html()),
                                    (t = i.find('td[data-field="' + p + '"]>div.layui-table-cell')).addClass(
            ...
            (B.removeNode = function(e, t, a) {
                ...
                if (n) {
                    ...
                    layui.each(n.treeToFlat(t), function(e, t) {
                        ...
                        l.hasNumberCol && v(n),
                        f &&
                        ((d = c.find('tr[lay-data-index="' + f[z] + '"]')),
                            a || (f[r] = !(!f[o] || !f[o].length)),
                            n.updateNodeIcon({ scopeEl: d, isExpand: f[H], isParent: f[r] })),
                        B.resize(e);
                }
            }),
            (B.addNodes = function(e, t) {
                ...
                if (a) {
                    ...
                    if (u) {
                        ...
                        u[s] = !0;
                        var y = (y = u[f]) ?
                            ((p = y.splice(-1 === o ? y.length : o)), (u[f] = y.concat(c, p))) :
                            (u[f] = c),
                            f =
                        ...
                        if (
                            ((P.cache[e] = P.cache[e].concat(c, p)),
                                ...
                                (n.page ?
                                    ((y = n.page),
                                        n.data.splice.apply(
                                            n.data, [y.limit * (y.curr - 1), y.limit].concat(P.cache[e])
                                        )) :
                                    (n.data = P.cache[e])),
                                a.initData(),
            ...
            (B.checkStatus = function(e, n) {
                ...
                if (l)
                    return (
                        ...
                        (a = !0),
                        layui.each('all' === l.data.cascade ? P.cache[e] : B.getData(e, !0), function(e, t) {
                            if (!t[i]) return !(a = !1);
                        }), { data: t, isAll: a }
                    );
            }),
                ...
                return (!!u.hasChecboxCol &&
                    ((a = u.tree),
                        ...
                        ((d = c.updateParentCheckStatus(e, 'boolean' === layui.type(t) ? t : null)),
                            layui.each(d, function(e, t) {
                                var a = i.find(
                                        'tr[lay-data-index="' + t[z] + '"]  input[name="layTableCheckbox"]:not(:disabled)'
                                    ),
                                    n = t[l];
                                c.setRowCheckedClass(a.closest('tr'), n),
                                    h.render(a.prop({ checked: n, indeterminate: t[g] }));
                            })),
                        (o = !(r = !0)),
                        0 <
                        (e = (e = 'all' === a.data.cascade ? P.cache[n] : B.getData(n, !0)).filter(function(e) {
                ...
                if (a) {
                    ...
                    if (!i)
                        return (
                            ...
                            h.render(d.prop({ checked: t, indeterminate: !1 })),
                    ...
                    a &&
                        (n.updateStatus(null, function(e) {
                                ...
                                e[u] &&
                                    ((t = r.find(
                                            'tr[lay-data-index="' + e[z] + '"] input[type="radio"][lay-type="layTableRadio"]'
                                        )),
                                        (e[u] = !1),
                                        n.setRowCheckedClass(t.closest('tr'), !1),
                                        h.render(t.prop('checked', !1)));
                            }),
                            (a[u] = t),
                            n.setRowCheckedClass(e, t),
                            n.setRowCheckedClass(e.siblings(), !1),
                            h.render(e.find('input[type="radio"][lay-type="layTableRadio"]').prop('checked', t)));
                }
            });
            ...
            c &&
                ...
                ((l = function(e) {
                        o.push(e),
                            ...
                            ((e = c.getNodeDataByIndex(e)[p]) && l(e));
                    }),
    ...
    (l.prototype.tree = function(r, e) {
        ...
        layui.each(e, function(e, i) {
                ...
                c = p(
                    [
                        ...
                        ((a = {
                            ...
                            (n = ['<div class="layui-btn-group layui-tree-btnGroup">']), !0 === s.edit && (s.edit = ['update', 'del']),
            ...
            t && (c.append(l), d.tree(l, i[o.children])),
                r.append(c),
                c.prev('.' + k)[0] &&
                c.prev().children('.layui-tree-pack').addClass('layui-tree-showLine'),
                ...
                i[0] ?
                    ...
                    (n.addClass(F),
                        ...
                        ((i = n.siblings('.' + k)).removeClass(F),
                            ...
                            i.find('.layui-tree-icon').children('.layui-icon').removeClass(x).addClass(v))) :
                    (s = 'normal');
            }),
            e.on('click', function() {
                p(this).hasClass(u) ||
                        ...
                        layui.each(i, function(e, i) {
                            if (a[l.id] == i)
                                return (
                                    ...
                                    n.push(i),
                                    a[l.children] && ((i[l.children] = []), c(a[l.children], i[l.children])), !0
                                );
                        });
                    });
                });
...
layui.define(['laytpl', 'form'], function(e) {
    ...
    (v.prototype.render = function() {
        var e = this,
            t = e.config,
            a = (e.elem = d(n(p, { open: '{{', close: '}}' }).render({ data: t, index: e.index }))),
            i = (t.elem = d(t.elem));
        i[0] &&
            ((t.data = t.data || []),
                (t.value = t.value || []),
    ...
    (v.prototype.renderCheckBtn = function(c) {
        ...
        r.layBox.each(function(e) {
                ...
                i.each(function() {
                    ...
                    c.stopNone ||
                    ((i = a.children('li:not(.' + s + ')').length), r.noneView(a, i ? '' : o.text.none));
            }),
                ...
                a[0].disabled ||
                    (!1 !==
                        ('function' == typeof l.dblclick ?
                            l.dblclick({ elem: t, data: n.getData([a[0].value])[0], index: i }) :
                            null) &&
                        n.transfer(i, t));
            }),
                ...
                var i = this.value,
                    ...
                    (t.each(function() {
                            var e = d(this),
                                ...
                                a = t[0].title,
                                a =
                                ('cs' !== l.showSearch && ((a = a.toLowerCase()), (i = i.toLowerCase())), -1 !== a.indexOf(i));
...
layui.define(['jquery', 'lay'], function(e) {
    ...
    (n.prototype.indicator = function() {
        ...
        i.elem.attr('lay-indicator', i.indicator),
            ...
            a.find('li').on('hover' === i.trigger ? 'mouseover' : i.trigger, function() {
                e['goto'](o(this).index());
            });
    }),
            ...
            (e.elem
                ...
                l.touchSwipe(t, {
                    onTouchEnd: function(e, n) {
                        ...
                        (0.25 < Math.abs(n / i) || Math.abs(n) > t[a ? 'height' : 'width']() / 3) &&
                        o.slide(0 < n ? '' : 'sub');
                    },
                }),
    ...
    (a.prototype.render = function() {
        ...
        for (
            ...
            var o =
                ...
                (n > Math.floor(a.value) ? h : f) +
                '" ' +
                t +
                '></i></li>';
            a.half && parseInt(a.value) !== a.value && n == Math.ceil(a.value) ?
                (i = i + '<li><i class="layui-icon layui-icon-rate-half" ' + t + '></i></li>') :
                (i += o);
        }
                ...
                l.on('click', function(e) {
                    ...
                    l.on('mousemove', function(e) {
                        t.find('i').each(function() {
                            ...
                            l.children('i').addClass(o).removeClass(f);
                    }),
                ...
                onTouchMove: function(e, a) {
                    ...
                    Date.now() - a.timeStart <= 200 ||
                        ((a = e.touches[0].pageX),
                            ...
                            (a = (a - t.offset().left) / e),
                            (i =
                                (i = (e = a % 1) <= 0.5 && n.half ? 0.5 + (a - e) : Math.ceil(a)) > n.length ?
                                n.length :
                                i) < 0 && (i = 0),
                            l.each(function(e) {
                                ...
                                t
                                    ?
                                    (a.addClass(f).removeClass(v), n.half && e && a.addClass(o).removeClass(f)) :
                                    a.addClass(h).removeClass(s),
            ...
            return (
                ...
                (d = function(o, l) {
                    ...
                    p[f ? 'after' : 'before'](o),
                        ...
                        r && r(),
                        f &&
                        ((o = s ? c.prop('scrollHeight') : document.documentElement.scrollHeight),
...
layui.define(['lay', 'util', 'element', 'form'], function(e) {
                ...
                (x.extend(!0,
                    ...
                    ((d = layui.code.index = ++W),
                        ...
                        ((M = 'LAY-CODE-DF-' + d),
                            ...
                            (_ = x(
                                '<div class="' + [A.ELEM_ITEM, A.ELEM_ITEM + '-preview', 'layui-border'].join(' ') +
                                '">'
                            )),
                        ...
                        l.highlighter &&
                        o.addClass([l.highlighter, 'language-' + l.lang, 'layui-code-hl'].join(' ')),
                        ...
                        l.header &&
                        ((_ = x('<div class="' + A.ELEM_HEADER + '"></div>')).html(l.title || l.text.code),
                            o.prepend(_)),
                        ...
                        ((C = x(
                            ...
                            M.append(C)),
                        l.langMarker &&
                        M.append('<span class="layui-code-lang-marker">' + l.lang + '</span>'),
    ...
    layui['layui.all'] || layui.addcss('modules/code.css?v=7', 'skincodecss');