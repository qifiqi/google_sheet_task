...
from ..models import GetParamTaskResultsListRequestDto, IdRequestDto, ParamTaskIdRequestDto, t_param_task_results
...
class ParamtaskresultsApi(ApiGroup):
    ...
    def get_data_by_page_list(
        self,
        request: GetParamTaskResultsListRequestDto | Mapping[str, Any],
    ) -> ResponseDto[Any]:
